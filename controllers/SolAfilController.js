...
Afil = mongoose3.model('Afiliados');
      ...
      try{
        ...
        if(!resultFindSolAfil){
          if(req.body.typeAprob==true){
            ...
            // resultFind = await Afil.findOneAndUpdate({ afilId: req.params.solAfilId,status:true,proceso: "pendiente"},{proceso:"aprobado",respaprob:req.body.respaprob},{new:true}).exec()
            ...
            if(resultFindAfiliado){
              ...
              resultFindAfiliadoUpdate.afilId=resultFind.cedula
